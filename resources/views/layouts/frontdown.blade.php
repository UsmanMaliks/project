            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-footer-widget">
                        ...
                        <p class="about-text">The world has become so fast paced that people don’t want to
                            stand by reading a page of information, they would much rather look at a presentation
                            and understand the message. It has come to a point where images and videos are used more
                            to </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p>
                        ...
                        </script> Bag and Pack Travel and Tour <i
                            class="fa fa-heart-o" aria-hidden="true"></i> by <a href=""
                            target="_blank">By HAFIZ USMAN RAHIM</a> 
                    </p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </p>
                </div>
