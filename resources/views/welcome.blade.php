@include('layouts.frontup')
            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-center">
                    <div class="banner_content">
                        <p>Plan a trip to All Over Pakistan</p>
                        <h2>Bag Pack</h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        ...
                        <div class="feature-thumb">
                            <img class="img-fluid" src="frontend/img/service/s1.png" alt="">
                        </div>
                    </div>
                </div>
                <!-- single-feature -->
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        ...
                        <div class="feature-thumb">
                            <img class="img-fluid" src="frontend/img/service/s2.png" alt="">
                        </div>
                    </div>
                </div>
                <!-- single-feature -->
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        ...
                        <div class="feature-thumb">
                            <img class="img-fluid" src="frontend/img/service/s3.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-lg-1 col-lg-6">
                    <img class="cta-img img-fluid" src="frontend/img/cta-img.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-package">
                        ...
                        {{-- <p class="date"><span>@date($tour->trip_date)</span> <br> December</p> --}}
                        <p class="date"><span>{{ htmlspecialchars_decode(date('D', strtotime($tour->trip_date))) }}</span> <br> {{ htmlspecialchars_decode(date('F Y', strtotime($tour->trip_date))) }}</p>
                        <div class="meta-top d-flex">
                            <p><span class="fa fa-location-arrow"></span>{{ $tour->cityname }}</p>
                            <p class="ml-20"><span class="fa fa-calendar"></span> {{ $tour->day }} days</p>
                        </div>
                        <h4>{{ $tour->name }}</h4>
                        <p>
                            {{ $tour->description }}
    ...
    <section class="popular-places-area section_gap_bottom">
        ...
        <div class="popular-places-slider owl-carousel">
            <a href="frontend/img/places/p1.jpg" class="single-popular-places d-block img-gal">
                <div class="popular-places-img">
                    <img src="frontend/img/places/p1.jpg" alt="">
                </div>
            ...
            <a href="frontend/img/places/p2.jpg" class="single-popular-places d-block img-gal">
                <div class="popular-places-img">
                    <img src="frontend/img/places/p2.jpg" alt="">
                </div>
                <div class="popular-places-text">
                    <p>Proper Guided Tour</p>
                    <h4>
            ...
            <a href="frontend/img/places/p3.jpg" class="single-popular-places d-block img-gal">
                <div class="popular-places-img">
                    <img src="frontend/img/places/p3.jpg" alt="">
                </div>
                <div class="popular-places-text">
                    <p>Proper Guided Tour</p>
                    <h4>
            ...
            <a href="frontend/img/places/p4.jpg" class="single-popular-places d-block img-gal">
                <div class="popular-places-img">
                    <img src="frontend/img/places/p4.jpg" alt="">
                </div>
                <div class="popular-places-text">
                    <p>Proper Guided Tour</p>
                    <h4>
        ...
        <div class="container">
            ...
            <div class="row team_inner">
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid w-100" src="frontend/img/team/team-1.jpg" alt="">
                            <div class="hover">
                                <h4>Randy Weaver</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid w-100" src="frontend/img/team/team-2.jpg" alt="">
                            <div class="hover">
                                <h4>Randy Weaver</h4>
                                <p>Senior Barrister at law</p>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid w-100" src="frontend/img/team/team-3.jpg" alt="">
                            <div class="hover">
                                <h4>Randy Weaver</h4>
                                <p>Senior Barrister at law</p>
                            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team_item">
                        <div class="team_img">
                            <img class="img-fluid w-100" src="frontend/img/team/team-4.jpg" alt="">
                            <div class="hover">
                                <h4>Randy Weaver</h4>
                                <p>Senior Barrister at law</p>
                            </div>
    ...
    <div class="cta-area2 section_gap">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="cta-img2 img-fluid" src="frontend/img/cta-img2.png" alt="">
                </div>
        ...
        <div class="container">
                    ...
                    <div class="testi-item">
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s">
                            <p>
                                ...
                                If you think about it, you travel
            ...
            <div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid rounded-circle" src="frontend/img/testimonial/t1.jpg" alt="">
                    </div>
                    <div class="overlay overlay-grad "></div>
                </div>
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid rounded-circle" src="frontend/img/testimonial/t2.jpg" alt="">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid rounded-circle" src="frontend/img/testimonial/t3.jpg" alt="">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
                <div class="owl-thumb-item">
                    <div>
                        <img class="img-fluid rounded-circle" src="frontend/img/testimonial/t4.jpg" alt="">
                    </div>
                    <div class="overlay overlay-grad"></div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-blog">
                        <div class="blog-thumb">
                            <img class="img-fluid" src="frontend/img/blog/h-blog1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-blog">
                        <div class="blog-thumb">
                            <img class="img-fluid" src="frontend/img/blog/h-blog2.jpg" alt="">
                        </div>
                        <div class="blog-details">
                            <div class="blog-meta d-flex">
                                <p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-blog">
                        <div class="blog-thumb">
                            <img class="img-fluid" src="frontend/img/blog/h-blog3.jpg" alt="">
                        </div>
                        <div class="blog-details">
                            <div class="blog-meta d-flex">
                                <p>
